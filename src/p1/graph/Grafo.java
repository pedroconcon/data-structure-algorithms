...
public class Grafo<TIPO> {
    ...
    public void buscaEmLargura(){
        ArrayList<Vertice<TIPO>> marcados = new ArrayList<>();//lista de vertices
        ArrayList<Vertice<TIPO>> fila = new ArrayList<>();//lista de vertices
        ...
        while(fila.size() > 0){
            ...
            for(int i =0;i<visitado.getArestasSaida().size();i++){
                ...
                if(!marcados.contains(proximo)){//se nao foi marcado
